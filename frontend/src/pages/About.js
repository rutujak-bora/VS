      ...
      <div className="relative z-10 bg-white/90">
        ...
        <section className="relative h-[300px] md:h-[400px] overflow-hidden">
          <div
            ...
            style={{
              backgroundImage: 'url(https://images.unsplash.com/photo-1558171813-4c088753af8f?w=1600)'
            }}
          />
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="aspect-square rounded-lg overflow-hidden border border-gray-100 shadow-sm">
                    <img src="/images/about/artisan.png" alt="Artisan at work" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="aspect-square rounded-lg overflow-hidden border border-gray-100 shadow-sm">
                    <img src="https://images.unsplash.com/photo-1574634534894-89d7576c8259?w=800" alt="Intricate embroidery" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                </div>
              </div>
            ...
            <div className="bg-pink-50/70 rounded-3xl p-8 md:p-16 mb-24 shadow-sm border border-pink-100/50 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
                <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg border-4 border-white transform transition duration-500 hover:-translate-y-2">
                  <img src="/images/about/at the workshop.jpeg" alt="At the workshop" className="w-full h-full object-cover" />
                </div>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg border-4 border-white transform transition duration-500 hover:-translate-y-2 lg:translate-y-8">
                  <img src="/images/about/master artisan block printing.jpeg" alt="Master artisan block printing" className="w-full h-full object-cover" />
                </div>
                <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-lg border-4 border-white transform transition duration-500 hover:-translate-y-2">
